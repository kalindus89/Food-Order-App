...
public class AdapterOrderStatus extends FirebaseRecyclerAdapter<OrderPlacedModel, AdapterOrderStatus.OderStatusViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull AdapterOrderStatus.OderStatusViewHolder holder, int position, @NonNull OrderPlacedModel model) {
    ...
    @NonNull
    @Override
    public AdapterOrderStatus.OderStatusViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
